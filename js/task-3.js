...
// Метод changeUsername(newName) повинен приймати рядок (нове імя) в параметр newName та 
...
// Значення змінної profile — це обєкт з властивостями username, playTime, getInfo, changeUsername і updatePlayTime
...
// Для звернення до властивостей обєкта в його методах використовується this